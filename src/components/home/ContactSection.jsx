    ...
    <section className="py-20 bg-[#ede8e0] font-inter" id="contact">
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md border border-[#e0d8d0]">
            ...
            <div className="p-5">
              ...
              <div className="space-y-1.5 text-xs text-[#6b5e52]">
                ...
                <div className="flex items-center gap-2">
                  <Phone className="w-3.5 h-3.5 text-[#8B6840] flex-shrink-0" />
                  <a href="tel:+905321592703" className="hover:text-[#8B6840] transition-colors">+90 532 159 27 03</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="contact-form" className="text-center mb-14">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-[#2d2419] font-playfair mb-4">{t.contactTitle}</h2>
