      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center">
          <motion.a
            ...
            animate={{ boxShadow: ["0 0 0px rgba(37,211,102,0)", "0 0 14px rgba(37,211,102,0.5)", "0 0 0px rgba(37,211,102,0)"] }}
            transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }}
            whileHover={{ scale: 1.06 }}
            whileTap={{ scale: 0.96 }}
            className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20bb5a] text-white text-xs font-bold uppercase tracking-wider px-4 py-2.5 rounded-full transition-colors"
          >
