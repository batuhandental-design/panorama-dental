...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] text-white pl-4 pr-5 py-3 rounded-full shadow-xl shadow-green-500/30 hover:bg-[#20bb5a] transition-colors"
    ...
    >
      ...
      <span className="text-sm font-semibold hidden sm:inline">WhatsApp'tan Yaz</span>
    </motion.a>
  );
}